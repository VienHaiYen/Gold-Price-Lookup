...
def startPage():
    ...
    tempIMG=(Image.open("./client/tech2.jpg"))
...
def entryHost():
    ...
    tempIMG=(Image.open("./client/nottech.jpg"))
...
def MainSearch():
    ...
    tempIMG=(Image.open("./client/square.png"))
    ...
    tempIMG=(Image.open("./client/exit.png"))
...
def sigIn():
    ...
    tempIMG=(Image.open("./client/tech3.jpg"))
    startImg=tempIMG.resize((800,400),Image.ANTIALIAS)
    new_image= ImageTk.PhotoImage(startImg)
...
def logIn():
    ...
    tempIMG=(Image.open("./client/tech5.jpg"))
    startImg=tempIMG.resize((800,400),Image.ANTIALIAS)
    new_image= ImageTk.PhotoImage(startImg)
...
errorImg=PhotoImage(file="./client/4042.jpg")
...
FORMAT="utf8"
CLIENT=socket(AF_INET,SOCK_STREAM)
def listenSeverShutdown():
    global CLIENT
    while True:
        try:
            msg=CLIENT.recv(BUFSIZE,MSG_PEEK).decode(FORMAT)
            if msg=="SHUTDOWN":
...
def catchHost(e=""):
    ...
    try:
        ...
        Thread(target=listenSeverShutdown,args=(),daemon=True).start()
        __init__()
    except:
